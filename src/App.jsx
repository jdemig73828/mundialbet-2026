...
// Fuente simulada: Clasificaciones FIFA/Confederaciones actualizadas. (Sin Italia).
const TEAMS = [
...
export default function App() {
  ...
  const [loginEmail, setLoginEmail] = useState('vecino@barrio.com');
  ...
  const LandingPage = () => (
    <div className="min-h-screen bg-slate-950 text-slate-300">
      {/* Hero Section con Imagen de Estadio */}
      <div 
    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-4 bg-slate-950">
      <div className="bg-slate-900 max-w-md w-full rounded-2xl shadow-2xl p-8 border border-slate-800">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-2 text-sm">Inicia sesión o crea tu cuenta para participar.</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          >
            Entrar al Portal <ChevronRight className="ml-2 h-5 w-5" />
          </button>
        </form>
        <div className="mt-6 text-center text-sm text-slate-400 bg-slate-950 p-4 rounded-lg border border-slate-800">
          <p className="mb-2 font-medium text-lime-400">⚡ Entorno de Pruebas Activo</p>
          <p className="mt-2 text-xs text-slate-400 leading-relaxed">
            Puedes escribir cualquier nombre/email en las casillas y pulsar "Entrar" para probar la plataforma por dentro.
          </p>
        </div>
      </div>
    </div>
